...
function createPDF($reportFilePath, $selectedReferenceName, $patientsFilesName, $positionNumbers, $reportSummary, $reportNucleotide, $reportAminoacid){
	$pdf = new Cezpdf('LETTER');
	$pdf -> selectFont('pdf/fonts/Helvetica.afm');
	$pdf -> ezSetCmMargins(3, 3, 3, 3);
	$pdf -> ezStartPageNumbers(500,50,12,'','',1);
	$size = 14;
	$pdf -> ezText("<b>BIOMEDICAL MUTATION ANALYSIS</b>", $size, array('justification' => 'center'));
	...
	$pdf -> ezText("Evaluated Positions: ".$positionNumbers, $size, array('justification' => 'left'));
	$pdf -> ezText("", $size, array('justification' => 'left'));
	$row=0;
