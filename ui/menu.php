	...
	<div class="container-fluid">
		<div class="navbar-collapse">
			<ul class="nav navbar-nav">
				<li>
					<a href="index.php"><img src="img/home.ico" width="20" /></a>
				</li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">Mutation Analysis<span class="caret"></span></a>
				...
				<li>
					<a href="<?php echo "index.php?pid=".base64_encode("ui/about.php") ?>">About BMA</a>
				</li>
				<li>
					<a href="<?php echo "index.php?pid=".base64_encode("ui/screencast.php") ?>">Screencast</a>
				</li>
			</ul>
		</div>
	</div>
