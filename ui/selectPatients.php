		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<form id="form" role="form" method="post" action="<?php echo "index.php?pid=".base64_encode("ui/validate.php")."&idGene=".$idGene."&nameMicroorganism=".$nameMicroorganism."&nameType=".$nameType ?>" enctype="multipart/form-data">
						<?php 
						...
						<div class='alert alert-warning' role='alert'>
							The sequences of patients must be included by plain text files. Each file represents one patient. One patient can have several sequences. Each sequence must include its name. Each file must follow the format of the example patient file  <a href="files/<?php echo $nameMicroorganism."/".$gene->getName() ?>.txt" target="_blank"><img src="img/file.ico" width='20' data-toggle='tooltip' data-placement='left' data-original-title='Example Patient File'></a>. Note that each sequence is placed without breaklines. <br>We provide you a test dataset, for using BMA. <a href="files/<?php echo $nameMicroorganism."/".$gene->getName() ?>.zip" ><img src="img/zip.ico" width='20' data-toggle='tooltip' data-placement='left' data-original-title='Dataset'></a>.
						</div>
						<div class='alert alert-warning' role='alert'>
							BMA do not store your patients information.
						</div>
