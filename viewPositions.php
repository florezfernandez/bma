<?php 
require("business/Gene.php");
require("business/Position.php");
require("business/Reference.php");
		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<form id="form" role="form" method="post" action="<?php echo "index.php?pid=".base64_encode("ui/selectPatients.php")."&idGene=".$idGene ?>" >
